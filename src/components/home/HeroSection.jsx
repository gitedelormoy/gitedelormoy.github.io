      ...
      <div className="relative z-10 min-h-[100dvh] flex flex-col justify-end px-8 md:px-16 lg:px-24 pb-20 md:pb-24">
        <div className="max-w-2xl">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="/le-gite" className="font-body text-white/70 text-sm hover:text-white transition-colors duration-300 tracking-wide underline underline-offset-4 decoration-white/30 hover:decoration-white/60">
              Découvrir le gîte
            </a>
          </div>
        </div>
